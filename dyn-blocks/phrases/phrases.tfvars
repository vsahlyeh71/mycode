upload_content = [
  ...
  { content = "Surfs Up! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "Holla! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
